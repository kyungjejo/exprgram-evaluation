        ...
        return (
            <div>
                ...
                <Segment className="instruction">
                    ...
                    <span style={{fontWeight:100}}>* Note that both <span id="target">expression A</span> and <span id="evaluate">expression B</span> are related expressions from 'Friends', the American sitcom.</span><br/><br/>
                    ...
                    <List ordered>
                        ...
                        <List.Item>
                            Score in scale of 1-7 on whether <span id="target">expression A</span> can be used in the same context of the video that <span id="evaluate">expression B</span> is used in.<br/>
                        </List.Item>
                        <List.Item>
                    ...
                    To answer the second and third question, you <strong>must watch the video</strong> that appears on the page.<br/><br/>
                ...
                <div className="instruction-set">
                    ...
                    <Link to={"/exprexpr"}><Button disabled={!ready || workerid===''} primary>Start</Button></Link>
                </div>
            </div>
        )
    }
